...
/**
 * Response for crypto OnRamp operations.
 */
@JsonInclude(JsonInclude.Include.NON_NULL)
public class CryptoOnRampOutput {
    @JsonProperty("status")
    ...
    @JsonProperty("data")
    private CryptoOnRampData data;

    // Default constructor
    public CryptoOnRampOutput() {}

    // Getters and setters
    public String getStatus() { return status; }
    public String getMessage() { return message; }
    public String getRedirectUrl() { return redirectUrl; }
    public CryptoOnRampData getData() { return data; }

    public void setStatus(String status) { this.status = status; }
    public void setMessage(String message) { this.message = message; }
    public void setRedirectUrl(String redirectUrl) { this.redirectUrl = redirectUrl; }
    public void setData(CryptoOnRampData data) { this.data = data; }

    public static class CryptoOnRampData {
