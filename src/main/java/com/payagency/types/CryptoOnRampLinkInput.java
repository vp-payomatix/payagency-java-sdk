...
public class CryptoOnRampLinkInput {
    ...
    public CryptoOnRampLinkInput() {}

    private CryptoOnRampLinkInput(Builder builder) {
    ...
    public static class Builder {
        ...
        public CryptoOnRampLinkInput build() {
            return new CryptoOnRampLinkInput(this);
        }
    }
