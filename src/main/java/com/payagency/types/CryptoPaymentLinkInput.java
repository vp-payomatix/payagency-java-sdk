...
public class CryptoPaymentLinkInput {
    ...
    private Integer fiatAmount; // For ONRAMP and PAYIN
    
    @JsonProperty("crypto_amount")
    private String cryptoAmount; // For OFFRAMP
    ...
    public CryptoPaymentLinkInput() {}

    private CryptoPaymentLinkInput(Builder builder) {
    ...
    public static class Builder {
        ...
        public Builder fiatAmount(Integer fiatAmount) {
        ...
        public CryptoPaymentLinkInput build() {
            return new CryptoPaymentLinkInput(this);
        }
    }
