...
/**
 * Response for crypto payment operations.
 */
@JsonInclude(JsonInclude.Include.NON_NULL)
public class CryptoPaymentOutput {
    @JsonProperty("status")
    ...
    // Default constructor
    public CryptoPaymentOutput() {}

    // Getters and setters
    public String getStatus() { return status; }
    public String getMessage() { return message; }
    public String getRedirectUrl() { return redirectUrl; }
    public CryptoPaymentData getData() { return data; }

    public void setStatus(String status) { this.status = status; }
    public void setMessage(String message) { this.message = message; }
    public void setRedirectUrl(String redirectUrl) { this.redirectUrl = redirectUrl; }
    public void setData(CryptoPaymentData data) { this.data = data; }

    public static class CryptoPaymentData {
