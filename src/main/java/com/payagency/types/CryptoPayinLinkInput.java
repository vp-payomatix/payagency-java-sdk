...
public class CryptoPayinLinkInput {
    ...
    public CryptoPayinLinkInput() {}

    private CryptoPayinLinkInput(Builder builder) {
    ...
    public static class Builder {
        ...
        public CryptoPayinLinkInput build() {
            return new CryptoPayinLinkInput(this);
        }
    }
