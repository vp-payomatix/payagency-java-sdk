...
/**
 * Input for crypto payment operations (OnRamp/OffRamp).
 */
@JsonInclude(JsonInclude.Include.NON_NULL)
public class CryptoPaymentInput {
    ...
    private CryptoPaymentInput(Builder builder) {
    ...
    public static class Builder {
        ...
        public CryptoPaymentInput build() {
            return new CryptoPaymentInput(this);
        }
    }
}
